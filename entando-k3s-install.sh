...
kubectl apply -f https://raw.githubusercontent.com/entando-k8s/entando-k8s-operator-bundle/v7.3.0/manifests/k8s-116-and-later/namespace-scoped-deployment/cluster-resources.yaml
...
kubectl apply -n $namespace -f https://raw.githubusercontent.com/entando-k8s/entando-k8s-operator-bundle/v7.3.0/manifests/k8s-116-and-later/namespace-scoped-deployment/namespace-resources.yaml
